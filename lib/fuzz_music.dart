...
import 'package:fuzz_movies/searchPageMusic.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzMusic extends StatefulWidget {
  const FuzzMusic({super.key});

  @override
  State<FuzzMusic> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzMusic> {
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageMusic()));
            },
          ), //IconButton
        ], //<Widget>[]
