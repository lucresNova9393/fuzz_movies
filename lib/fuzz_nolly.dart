...
import 'package:fuzz_movies/searchPageNolly.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzNolly extends StatefulWidget {
  const FuzzNolly({super.key});

  @override
  State<FuzzNolly> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzNolly> {
  ...
  Widget build(BuildContext context) {
    ...
    MaterialPageRoute(
    builder: (context)=>SearchPageNolly()));
            },
          ), //IconButton
        ], //<Widget>[]
