...
import 'package:fuzz_movies/screens/search/search.dart';
import 'package:fuzz_movies/searchPageHolly.dart';
import 'package:fuzz_movies/searchPageHolly1.dart';
...
class FuzzHolly1 extends StatefulWidget {
  const FuzzHolly1({super.key});

  @override
  State<FuzzHolly1> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzHolly1> {
            ...
            child: Column(
              children: [
                AnimatedDefaultTextStyle(style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),
                    ...
                    child: const Text('Hollywood Movies')),
                Text('Get the best and latest movies',style: TextStyle(fontSize: 12,color: Colors.deepPurple),)
              ],
            )
        ),
        actions: <Widget>[
          //const { data, error } = await supabase.from('fuzz_holly').upsert({ some_column: 'someValue' }).select()
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageHolly1()));
            },
          ), //IconButton
        ], //<Widget>[]
