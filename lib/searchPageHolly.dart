...
class SearchPageHolly extends StatefulWidget {
  const SearchPageHolly({super.key});

  @override
  State<SearchPageHolly> createState() => _SearchPageHollyState();
}
...
class _SearchPageHollyState extends State<SearchPageHolly> {
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchHolly());
              },
