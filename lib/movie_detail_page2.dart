...
class MovieDetailPage2 extends StatelessWidget {
  ...
  const MovieDetailPage2({super.key, required this.movieList,});
  ...
  Widget build(BuildContext context) {
    ...
    var Title =movieList.title;
    var Download =movieList.downloads;
    var download =movieList.downloads;
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            ...
            Card(
              ...
              child: CachedNetworkImage(
                ...
                //height: h,
                fit: BoxFit.contain,
                imageUrl: '${movieList.detailPageImage}',
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Expanded(child: Center(child: Text('${movieList.description}'))),
              ),
            ),
