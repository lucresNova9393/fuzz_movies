...
import 'package:fuzz_movies/searchPageBolly1.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzBolly1 extends StatefulWidget {
  const FuzzBolly1({super.key});

  @override
  State<FuzzBolly1> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzBolly1> {
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageBolly1()));
            },
          ), //IconButton
        ], //<Widget>[]
