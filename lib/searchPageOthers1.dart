...
import 'package:fuzz_movies/search_others1.dart';

import 'movie_detail_page.dart';

class SearchPageOthers1 extends StatefulWidget {
  const SearchPageOthers1({super.key});

  @override
  State<SearchPageOthers1> createState() => _SearchPageOthers1State();
}
...
class _SearchPageOthers1State extends State<SearchPageOthers1> {
  ...
  FetchMoviesOthers _movieList = FetchMoviesOthers();
  @override
  Widget build(BuildContext context) {
    return  SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: Text('Search for foreign movies'),
            centerTitle: true,
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchOthers1());
              },
