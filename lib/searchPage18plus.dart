...
class SearchPage18plus extends StatefulWidget {
  const SearchPage18plus({super.key});

  @override
  State<SearchPage18plus> createState() => _SearchPage18plusState();
}
...
class _SearchPage18plusState extends State<SearchPage18plus> {
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: Search18plus());
              },
