...
import 'package:fuzz_movies/searchPage18plus.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class Fuzz18plus extends StatefulWidget {
  const Fuzz18plus({super.key});

  @override
  State<Fuzz18plus> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<Fuzz18plus> {
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPage18plus()));
            },
          ), //IconButton
        ], //<Widget>[]
