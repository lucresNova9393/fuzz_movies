...
class SearchPageBolly extends StatefulWidget {
  const SearchPageBolly({super.key});

  @override
  State<SearchPageBolly> createState() => _SearchPageBollyState();
}
...
class _SearchPageBollyState extends State<SearchPageBolly> {
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchBolly());
              },
