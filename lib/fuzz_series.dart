...
import 'package:fuzz_movies/searchPageSeries.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzSeries extends StatefulWidget {
  const FuzzSeries({super.key});

  @override
  State<FuzzSeries> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzSeries> {
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            tooltip: 'Series Movies',
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageSeries()));
            },
          ), //IconButton
        ], //<Widget>[]
