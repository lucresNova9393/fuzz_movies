...
class SearchPageOthers extends StatefulWidget {
  const SearchPageOthers({super.key});

  @override
  State<SearchPageOthers> createState() => _SearchPageOthersState();
}
...
class _SearchPageOthersState extends State<SearchPageOthers> {
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchOthers());
              },
