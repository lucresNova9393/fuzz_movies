...
class SearchPageMusicVideos extends StatefulWidget {
  const SearchPageMusicVideos({super.key});

  @override
  State<SearchPageMusicVideos> createState() => _SearchPageMusicVideosState();
}
...
class _SearchPageMusicVideosState extends State<SearchPageMusicVideos> {
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchMusicVideos());
              },
