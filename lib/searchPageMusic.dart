...
class SearchPageMusic extends StatefulWidget {
  const SearchPageMusic({super.key});

  @override
  State<SearchPageMusic> createState() => _SearchPageMusicState();
}
...
class _SearchPageMusicState extends State<SearchPageMusic> {
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchMusic());
              },
