...
class SearchPageNolly extends StatefulWidget {
  const SearchPageNolly({super.key});

  @override
  State<SearchPageNolly> createState() => _SearchPageNollyState();
}
...
class _SearchPageNollyState extends State<SearchPageNolly> {
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchNolly());
              },
