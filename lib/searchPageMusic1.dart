...
import 'package:fuzz_movies/search_music1.dart';
import 'package:fuzz_movies/search_nolly.dart';

import 'movie_detail_page.dart';

class SearchPageMusic1 extends StatefulWidget {
  const SearchPageMusic1({super.key});

  @override
  State<SearchPageMusic1> createState() => _SearchPageMusic1State();
}
...
class _SearchPageMusic1State extends State<SearchPageMusic1> {
  ...
  FetchMoviesMusic _movieList = FetchMoviesMusic();
  @override
  Widget build(BuildContext context) {
    return  SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: Text('Search for Music'),
            centerTitle: true,
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchMusic1());
              },
