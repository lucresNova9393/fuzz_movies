...
import 'package:fuzz_movies/searchPageMusic1.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzMusic1 extends StatefulWidget {
  const FuzzMusic1({super.key});

  @override
  State<FuzzMusic1> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzMusic1> {
  final _movieStream = Supabase.instance.client.from('fuzz_music').stream(['id']).order('id', ascending: false).execute();
        ...
        title: GestureDetector(
            ...
            child: Column(
              children: [
                ...
                Text('Get the best and latest music',style: TextStyle(fontSize: 12,color: Colors.deepPurple),)
              ],
            )),
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageMusic1()));
            },
          ), //IconButton
        ], //<Widget>[]
