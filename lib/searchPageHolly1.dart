...
class SearchPageHolly1 extends StatefulWidget {
  const SearchPageHolly1({super.key});

  @override
  State<SearchPageHolly1> createState() => _SearchPageHolly1State();
}
...
class _SearchPageHolly1State extends State<SearchPageHolly1> {
  ...
  Widget build(BuildContext context) {
    return  SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: Text('Search for Hollywood Movies'),
            centerTitle: true,
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchHolly1());
              },
