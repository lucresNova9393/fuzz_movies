...
import 'package:fuzz_movies/searchPageOthers.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzOthers extends StatefulWidget {
  const FuzzOthers({super.key});

  @override
  State<FuzzOthers> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzOthers> {
  final _movieStream = Supabase.instance.client.from('fuzz_others').stream(['id']).order('id', ascending: false).execute();
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageOthers()));
            },
          ), //IconButton
        ], //<Widget>[]
