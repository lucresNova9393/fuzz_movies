...
import 'package:fuzz_movies/searchPageOthers1.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzOthers1 extends StatefulWidget {
  const FuzzOthers1({super.key});

  @override
  State<FuzzOthers1> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzOthers1> {
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageOthers1()));
            },
          ), //IconButton
        ], //<Widget>[]
