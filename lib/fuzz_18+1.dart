...
import 'package:fuzz_movies/searchPage18plus1.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class Fuzz18plus1 extends StatefulWidget {
  const Fuzz18plus1({super.key});

  @override
  State<Fuzz18plus1> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<Fuzz18plus1> {
  final _movieStream = Supabase.instance.client.from('fuzz_18plus').stream( ['id']).order('id', ascending: false).execute();
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPage18plus1()));
            },
          ), //IconButton
        ], //<Widget>[]
