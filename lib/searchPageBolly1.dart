...
import 'package:fuzz_movies/search_bolly1.dart';
...
class SearchPageBolly1 extends StatefulWidget {
  const SearchPageBolly1({super.key});

  @override
  State<SearchPageBolly1> createState() => _SearchPageBolly1State();
}
...
class _SearchPageBolly1State extends State<SearchPageBolly1> {
  ...
  FetchMoviesBolly _movieList = FetchMoviesBolly();
  @override
  Widget build(BuildContext context) {
    return  SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: Text('Search for Bollywood Movies'),
            centerTitle: true,
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchBolly1());
              },
