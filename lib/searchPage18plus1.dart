...
import 'package:fuzz_movies/API_services4.dart';
import 'package:fuzz_movies/API_services5.dart';
import 'package:fuzz_movies/API_services6.dart';
import 'package:fuzz_movies/API_services7.dart';
import 'package:fuzz_movies/MovieModel.dart';
import 'package:fuzz_movies/movie_detail_page2.dart';
import 'package:fuzz_movies/search_18plus.dart';
import 'package:fuzz_movies/search_18plus1.dart';
...
import 'package:fuzz_movies/search_music.dart';
import 'package:fuzz_movies/search_music_videos.dart';
import 'package:fuzz_movies/search_nolly.dart';
import 'package:fuzz_movies/search_others.dart';

import 'movie_detail_page.dart';

class SearchPage18plus1 extends StatefulWidget {
  const SearchPage18plus1({super.key});

  @override
  State<SearchPage18plus1> createState() => _SearchPage18plus1State();
}
...
class _SearchPage18plus1State extends State<SearchPage18plus1> {
  ...
  FetchMovies18plus _movieList = FetchMovies18plus();
  @override
  Widget build(BuildContext context) {
    return  SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: Text('Search for adult movies'),
            centerTitle: true,
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: Search18plus1());
              },
