...
import 'package:fuzz_movies/search_music_videos1.dart';
import 'package:fuzz_movies/search_nolly.dart';

import 'movie_detail_page.dart';

class SearchPageMusicVideos1 extends StatefulWidget {
  const SearchPageMusicVideos1({super.key});

  @override
  State<SearchPageMusicVideos1> createState() => _SearchPageMusicVideos1State();
}
...
class _SearchPageMusicVideos1State extends State<SearchPageMusicVideos1> {
  ...
  FetchMoviesMusicVideos _movieList = FetchMoviesMusicVideos();
  @override
  Widget build(BuildContext context) {
    return  SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: Text('Search for Music Videos'),
            centerTitle: true,
            actions: [
              IconButton(onPressed: (){
                showSearch(context: context, delegate: SearchMusicVideos1());
              },
