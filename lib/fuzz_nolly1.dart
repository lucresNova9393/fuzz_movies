...
import 'package:fuzz_movies/searchPageNolly1.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import 'movie_detail_page.dart';

class FuzzNolly1 extends StatefulWidget {
  const FuzzNolly1({super.key});

  @override
  State<FuzzNolly1> createState() => _FuzzHollyState();
}
...
class _FuzzHollyState extends State<FuzzNolly1> {
  final _movieStream = Supabase.instance.client.from('fuzz_nolly').stream( ['id']).order('id', ascending: false).execute();
            ...
            child: Column(
              children: [
                AnimatedDefaultTextStyle(style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),
                    ...
                    child: const Text('Nollywood Movies')),
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(
                      builder: (context)=>SearchPageNolly1()));
            },
          ), //IconButton
        ], //<Widget>[]
